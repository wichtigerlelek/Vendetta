...
{
	LoadLibraryInjection,		 // Default LoadLibraryA injection (Loud)
...
constexpr bool FIND_HANDLE_TO_TARGET = true;                                      // Whether to find and log which processes hold handles to the target process
